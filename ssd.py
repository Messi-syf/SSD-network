...
class SSD(object):
    _defaults = {
        "model_path": '%s/model_data/ssd_weights.h5'%(a),
        "classes_path": '%s/model_data/voc_classes.txt'%(a),
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font='%s/model_data/simhei.ttf'%(a),size=np.floor(3e-2 * np.shape(image)[1] + 0.5).astype('int32'))
